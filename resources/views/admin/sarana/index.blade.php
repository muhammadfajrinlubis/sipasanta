...
<div class="row">
   <div class="col-md-12 col-sm-12">
      <div class="widget p-md clearfix">
         <div class="pull-left">
            <h1 class="widget-title" style="font-size: 30px; margin-bottom: 5px;">Data Saran Prasarana</h1>
            <small class="text-color">Data Master <span style="margin:0px 3px 0px 3px"> > </span> <a href="/admin/sarana">List Data sarana Prasarana</a></small>
         </div>
         ...
         <header class="widget-header">
            <div class="pull-left">
               <h4 class="widget-title" style="font-size:24px;">
                  <i class="glyphicon glyphicon-list"></i> List Data Sarana Prasarana
               </h4>
            </div>
            <div class="pull-right">
               <a href="/admin/sarana/add" class="btn btn-primary btn-sm">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td class="text-center" width="15%">
                           <a href="/admin/sarana/edit/{{$data->id}}">
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-body">
            ...
            <div class="row mt-1">
               <div class="col-md-6">
                  <a href="/admin/sarana/delete/{{$data->id}}" style="text-decoration: none;">
