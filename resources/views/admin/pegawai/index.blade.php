   ...
   <div class="col-md-12 col-sm-12">
      <div class="widget p-md clearfix">
         <div class="pull-left">
            ...
            <small class="text-color">Data User <span style="margin:0px 3px 0px 3px"> > </span> <a href="/admin/pegawai">List Data Pegawai</a></small>
         </div>
         ...
         <header class="widget-header">
            <div class="pull-left">
               <h4 class="widget-title" style="font-size:24px;">
                  <i class="glyphicon glyphicon-list"></i> List Data Pegawai
               </h4>
            </div>
            <div class="pull-right">
               <a href="/admin/pegawai/add" class="btn btn-primary btn-sm">
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-body">
            ...
            <hr>
            <form method="post" action="/admin/pegawai/import" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="form-group">
                   ...
                   <div class="row mt-1">
                     <div class="col-md-6">
                       <a href="{{url('template/Template Pegawai.xlsx')}}">
...
<div class="modal fade" id="resetModal-{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="resetModalLabel-{{ $data->id }}" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form method="POST" action="/admin/pegawai/reset-password/{{ $data->id }}">
            @csrf
            <div class="modal-content">
                <div class="modal-body">
                    <h2 class="text-center">Reset Password Pegawai</h2>
                    <hr>
