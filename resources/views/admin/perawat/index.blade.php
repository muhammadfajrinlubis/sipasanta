...
<div class="row">
   <div class="col-md-12 col-sm-12">
      <div class="widget p-md clearfix">
         <div class="pull-left">
            <h1 class="widget-title" style="font-size: 30px; margin-bottom: 5px;">Data Admin Perawat</h1>
            <small class="text-color">Data User <span style="margin:0px 3px 0px 3px"> > </span> <a href="/admin/perawat">List Data Admin Perawat</a></small>
         </div>
         ...
         <header class="widget-header">
            <div class="pull-left">
               <h4 class="widget-title" style="font-size:24px;">
                  <i class="glyphicon glyphicon-list"></i> List Data Admin Perawat
               </h4>
            </div>
                  ...
                  <tbody>
                     ...
                     <tr>
                         ...
                         <td class="text-center align-middle-custom" width="15%">
                             <a href="/admin/perawat/edit/{{$data->id}}">
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-body">
            ...
            <hr>
            <form method="post" action="/admin/perawat/import" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="form-group">
                   ...
                   <div class="row mt-1">
                     <div class="col-md-6">
                       <a href="{{url('template/Template perawat.xlsx')}}">
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content">
         <div class="modal-body">
            ...
            <div class="row mt-1">
               <div class="col-md-6">
                  <a href="/admin/perawat/delete/{{$data->id}}" style="text-decoration: none;">
