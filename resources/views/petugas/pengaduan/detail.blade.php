    ...
    <div class="col-md-12 col-sm-12">
        <div class="widget p-md clearfix">
            <div class="pull-left">
                ...
                <small class="text-color">Pengaduan <span style="margin:0px 3px 0px 3px"> > </span> <a href="/petugas/pengaduan">Data Pengaduan</a> <span style="margin:0px 3px 0px 3px"> > </span> <a href="/petugas/pengaduan/detail/{{$pengaduan->id}}">Detail Data Pengaduan</a></small>
            </div>
        </div>
    </div>
</div>
